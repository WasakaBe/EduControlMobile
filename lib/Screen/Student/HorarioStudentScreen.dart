...
void _showInfoDocente(BuildContext context, dynamic docenteData) {
  showDialog(
    ...
    builder: (BuildContext context) {
      final mediaQuery = MediaQuery.of(context); // Obtenemos el tamaño de la pantalla
      ...
      return AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            children: [
              // Foto en forma circular del docente
              docenteData['docente_foto'] != null
                  ? CircleAvatar(
                      radius: mediaQuery.size.width * 0.15, // Ajusta el tamaño del círculo
                      backgroundImage: MemoryImage(base64Decode(docenteData['docente_foto'])),
                    )
                  : const CircleAvatar(
                      radius: 50,
              ...
              const SizedBox(height: 20), // Espacio entre la foto y la información
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  // Llamar a la función para mostrar la información del docente

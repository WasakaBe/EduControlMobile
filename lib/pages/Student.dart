...
import 'dart:convert';
import '../Sections/Students/HorarioEscolar.dart';
import '../Sections/Students/CredencialAlumno.dart';
import '../Sections/Students/NotificacionesAlumno.dart'; // Importa la pantalla de NotificacionesAlumno
...
class StudentScreen extends StatefulWidget {
  ...
  const StudentScreen(
      {super.key, required this.nombreUsuario, required this.idUsuario});
...
class _StudentScreenState extends State<StudentScreen> {
  ...
  Widget _getScreen(int index) {
    switch (index) {
      ...
      case 1:
        return HorarioEscolarScreen(idUsuario: widget.idUsuario);
      case 2:
        return CredencialAlumnoScreen(idUsuario: widget.idUsuario);
      case 3:
        return NotificacionesAlumnoScreen(idUsuario: widget.idUsuario);
      default:
        return _dashboardView();
    }
  }
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              ...
              // Esto puede ser redirigir a la pantalla de inicio o realizar alguna otra acción
              Navigator.pop(

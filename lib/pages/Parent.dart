...
import 'package:edu_control_movile/Sections/Parent/agregaralumno.dart'; // Importar la pantalla de agregar alumno
import 'package:edu_control_movile/Sections/Parent/veralumnosfam.dart'; // Importar la pantalla de ver alumnos
...
class _ParentScreenState extends State<ParentScreen> {
  ...
  Widget _getScreen(int index) {
    switch (index) {
      ...
      case 1:
        return AgregarAlumnoScreen(idUsuario: widget.idUsuario);
      case 2:
        return VerAlumnosFamScreen(idUsuario: widget.idUsuario);
      default:
        return _dashboardView();
    }
  }
